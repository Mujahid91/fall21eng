...
public class PassByValue01 {
    ...
    public static void main(String[] args) {
        ...
        //If you cannot update the value of a date type without assignment, those data types are called
        //"immutable" data types. So String is immutable.
        String s = "Ali";
        System.out.println("From the method: " + updateString(s));//Ali!
        System.out.println(s);//Ali
        
        //In Lists, we can update the value without using assignment,
        //because of that List are called "mutable" data types
