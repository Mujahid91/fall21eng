...
public class Arrays02 {
	...
	public static void main(String[] args) {
		...
		String s1[] = {"S", "A", "T"};
		System.out.println("Befor sorting: " + Arrays.toString(s1));
		...
		//String s2[] = s1;
		System.out.println("Befor sorting: " + Arrays.toString(s2));
		
		Arrays.sort(s1);
		System.out.println("Afrer sorting: " + Arrays.toString(s1));
